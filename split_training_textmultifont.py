...
output_directory = 'tesstrain/data/300newsRanbac-ground-truth'
...
line_count = 13000
fonts = ['SimSun', 'SimHei', 'KaiTi', 'DengXian', 'DengXian Light', 'Microsoft YaHei', 'Noto Sans CJK SC', 'Noto Sans SC', 'Noto Sans SC Bold', 'Noto Serif SC', 'Source Han Sans SC', 'Source Han Serif SC', 'FangSong', 'PingFang SC', 'LiGuoFu']  # List of fonts
