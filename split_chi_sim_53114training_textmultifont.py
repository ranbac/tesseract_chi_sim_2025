...
output_directory = 'tesstrain/data/NewRanbac-ground-truth'
...
line_count = 1
fonts = ['SimSun', 'SimHei', 'KaiTi', 'DengXian', 'Microsoft YaHei', 'Noto Serif SC', 'Source Han Serif SC', 'FangSong', 'PingFang SC',  'Noto Sans SC', 'Source Han Sans SC', 'WenQuanYi Zen Hei Medium']  # List of fonts
